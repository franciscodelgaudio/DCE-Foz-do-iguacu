...
export const COORDINATIONS = [
    ...
    { key: "direcao",     label: "Direção Executiva",                         goal: 1 },
...
// Número mínimo de publicações para um slot ser considerado preenchido
export const SLOT_REQUIRED = 2

// Coordenações em rodízio (ordem define a vez de cada slot; inclui apenas as com meta > 0)
export const ROTATION = COORDINATIONS.filter((c) => c.goal > 0).map((c) => c.key)
